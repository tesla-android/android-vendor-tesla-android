...
_1593: (x0,x1,x2) => x0.postMessage(x1,x2),
...
_1701: () => globalThis.performance,
_1702: () => globalThis.JSON,
_1703: x0 => x0.measure,
_1704: x0 => x0.mark,
_1705: (x0,x1,x2,x3) => x0.measure(x1,x2,x3),
_1706: (x0,x1,x2) => x0.mark(x1,x2),
_1707: (x0,x1) => x0.parse(x1),
...
_1718: () => Date.now(),
_1724: () => new XMLHttpRequest(),
_1725: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1726: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1727: (x0,x1) => x0.send(x1),
_1728: x0 => x0.abort(),
_1729: x0 => x0.getAllResponseHeaders(),
_1737: f => finalizeWrapper(f,x0 => dartInstance.exports._1737(f,x0)),
_1755: (x0,x1) => x0.key(x1),
_1756: (a, i) => a.push(i),
_1760: a => a.pop(),
...
_1779: s => s.trimLeft(),
_1780: s => s.trimRight(),
_1782: (s, p, i) => s.indexOf(p, i),
_1783: (s, p, i) => s.lastIndexOf(p, i),
...
_1831: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1832: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1834: (s, m) => {
          try {
...
_1835: (x0,x1) => x0.exec(x1),
_1836: (x0,x1) => x0.test(x1),
_1837: (x0,x1) => x0.exec(x1),
_1838: (x0,x1) => x0.exec(x1),
_1839: x0 => x0.pop(),
_1843: (x0,x1,x2) => x0[x1] = x2,
_1845: o => o === undefined,
_1846: o => typeof o === 'boolean',
_1847: o => typeof o === 'number',
_1849: o => typeof o === 'string',
_1852: o => o instanceof Int8Array,
_1853: o => o instanceof Uint8Array,
_1854: o => o instanceof Uint8ClampedArray,
_1855: o => o instanceof Int16Array,
_1856: o => o instanceof Uint16Array,
_1857: o => o instanceof Int32Array,
_1858: o => o instanceof Uint32Array,
_1859: o => o instanceof Float32Array,
_1860: o => o instanceof Float64Array,
_1861: o => o instanceof ArrayBuffer,
_1862: o => o instanceof DataView,
_1863: o => o instanceof Array,
_1864: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_1866: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_1867: o => o instanceof RegExp,
_1868: (l, r) => l === r,
_1869: o => o,
_1870: o => o,
_1871: o => o,
...
_1873: o => o.length,
_1876: (o, i) => o[i],
_1877: f => f.dartFunction,
_1878: l => arrayFromDartList(Int8Array, l),
_1879: l => arrayFromDartList(Uint8Array, l),
_1880: l => arrayFromDartList(Uint8ClampedArray, l),
_1881: l => arrayFromDartList(Int16Array, l),
_1882: l => arrayFromDartList(Uint16Array, l),
_1883: l => arrayFromDartList(Int32Array, l),
_1884: l => arrayFromDartList(Uint32Array, l),
_1885: l => arrayFromDartList(Float32Array, l),
_1886: l => arrayFromDartList(Float64Array, l),
_1887: (data, length) => {
...
_1888: l => arrayFromDartList(Array, l),
_1889: stringFromDartString,
_1890: stringToDartString,
_1891: () => ({}),
_1892: () => [],
_1893: l => new Array(l),
_1894: () => globalThis,
_1895: (constructor, args) => {
...
_1897: (o, p) => o[p],
_1898: (o, p, v) => o[p] = v,
_1899: (o, m, a) => o[m].apply(o, a),
_1901: o => String(o),
_1902: (p, s, f) => p.then(s, f),
_1903: s => {
...
_1946: x0 => x0.matches,
_1950: x0 => x0.platform,
_1955: x0 => x0.navigator,
_2003: (x0,x1) => x0.withCredentials = x1,
_2006: x0 => x0.responseURL,
_2007: x0 => x0.status,
_2008: x0 => x0.statusText,
_2009: (x0,x1) => x0.responseType = x1,
_2011: x0 => x0.response,
_2089: x0 => x0.style,
_2577: (x0,x1) => x0.src = x1,
_3768: () => globalThis.window,
_3825: x0 => x0.document,
_3828: x0 => x0.location,
_3848: x0 => x0.navigator,
_4106: x0 => x0.localStorage,
_4118: x0 => x0.protocol,
_4122: x0 => x0.hostname,
_4329: x0 => x0.userAgent,
_4378: x0 => x0.data,
_4547: x0 => x0.length,
_8724: x0 => x0.baseURI,
_8741: () => globalThis.document,
_12023: (x0,x1) => x0.border = x1
    };
