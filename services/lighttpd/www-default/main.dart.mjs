...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1265: (x0,x1,x2) => x0.postMessage(x1,x2),
      _1278: () => globalThis.getAudioState(),
      _1279: () => globalThis.stopAudio(),
      _1280: () => globalThis.startAudioFromGesture(),
      _1281: x0 => x0.reload(),
      _1284: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1285: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1286: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1302: (x0,x1) => x0.getItem(x1),
      _1304: (x0,x1,x2) => x0.setItem(x1,x2),
      ...
      _1307: (x0,x1) => ({output: x0,error: x1}),
      _1308: x0 => new VideoDecoder(x0),
      _1309: x0 => x0.close(),
      _1310: (x0,x1,x2,x3) => ({type: x0,timestamp: x1,duration: x2,data: x3}),
      _1311: x0 => new EncodedVideoChunk(x0),
      _1312: (x0,x1) => x0.decode(x1),
      _1313: (x0,x1) => x0.configure(x1),
      _1314: (x0,x1,x2,x3,x4,x5,x6) => ({codec: x0,codedWidth: x1,codedHeight: x2,displayAspectWidth: x3,displayAspectHeight: x4,hardwareAcceleration: x5,optimizeForLatency: x6}),
      _1315: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1315(f,arguments.length,x0) }),
      _1316: f => finalizeWrapper(f, function() { return dartInstance.exports._1316(f,arguments.length) }),
      _1317: () => ({}),
      _1318: (x0,x1,x2,x3) => x0.getCurrentPosition(x1,x2,x3),
      _1319: x0 => ({name: x0}),
      _1320: (x0,x1) => x0.query(x1),
      _1321: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1321(f,arguments.length,x0) }),
      _1322: f => finalizeWrapper(f, function() { return dartInstance.exports._1322(f,arguments.length) }),
      _1325: Date.now,
      _1327: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1328: s => {
      ...
      _1363: Object.is,
      _1364: o => o instanceof Array,
      _1369: a => a.pop(),
      _1370: (a, i) => a.splice(i, 1),
      _1371: (a, s) => a.join(s),
      _1372: (a, s, e) => a.slice(s, e),
      _1374: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1375: a => a.length,
      _1377: (a, i) => a[i],
      _1378: (a, i, v) => a[i] = v,
      _1380: o => {
      ...
      _1381: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1383: o => o instanceof Uint8Array,
      _1384: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1385: o => o instanceof Int8Array,
      _1386: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1387: o => o instanceof Uint8ClampedArray,
      _1388: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1389: o => o instanceof Uint16Array,
      _1390: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1391: o => o instanceof Int16Array,
      _1392: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1393: o => o instanceof Uint32Array,
      _1394: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1395: o => o instanceof Int32Array,
      _1396: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1398: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1399: o => o instanceof Float32Array,
      _1400: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1401: o => o instanceof Float64Array,
      ...
      _1449: () => Date.now(),
      _1454: o => Object.keys(o),
      _1455: (x0,x1) => new WebSocket(x0,x1),
      _1456: (x0,x1) => x0.send(x1),
      _1457: (x0,x1,x2) => x0.close(x1,x2),
      _1458: (x0,x1) => x0.close(x1),
      _1459: x0 => x0.close(),
      _1460: () => new XMLHttpRequest(),
      _1461: (x0,x1,x2) => x0.open(x1,x2),
      _1462: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1463: x0 => x0.abort(),
      _1464: (x0,x1) => x0.send(x1),
      _1465: x0 => x0.send(),
      _1466: x0 => x0.getAllResponseHeaders(),
      _1467: () => new AbortController(),
      _1468: x0 => x0.abort(),
      _1469: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1470: (x0,x1) => globalThis.fetch(x0,x1),
      _1471: (x0,x1) => x0.get(x1),
      _1472: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1472(f,arguments.length,x0,x1,x2) }),
      _1473: (x0,x1) => x0.forEach(x1),
      _1474: x0 => x0.getReader(),
      _1475: x0 => x0.read(),
      _1476: x0 => x0.cancel(),
      ...
      _1489: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      _1490: (x0,x1) => x0.key(x1),
      _1500: (s, m) => {
        try {
      ...
      _1533: o => [o],
      _1534: (o0, o1) => [o0, o1],
      _1535: (o0, o1, o2) => [o0, o1, o2],
      _1536: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1550: x0 => x0.index,
      _1552: x0 => x0.flags,
      _1553: x0 => x0.multiline,
      _1554: x0 => x0.ignoreCase,
      _1555: x0 => x0.unicode,
      _1556: x0 => x0.dotAll,
      _1557: (x0,x1) => { x0.lastIndex = x1 },
      _1558: (o, p) => p in o,
      _1559: (o, p) => o[p],
      _1562: x0 => x0.random(),
      _1565: () => globalThis.Math,
      _1566: Function.prototype.call.bind(Number.prototype.toString),
      _1567: Function.prototype.call.bind(BigInt.prototype.toString),
      _1568: Function.prototype.call.bind(Number.prototype.toString),
      _1569: (d, digits) => d.toFixed(digits),
      _1576: x0 => x0.codedWidth,
      _1577: x0 => x0.codedHeight,
      _1578: x0 => x0.format,
      _1588: x0 => x0.codec,
      _1596: x0 => x0.state,
      _1677: x0 => x0.readyState,
      _1679: (x0,x1) => { x0.timeout = x1 },
      _1681: (x0,x1) => { x0.withCredentials = x1 },
      _1682: x0 => x0.upload,
      _1683: x0 => x0.responseURL,
      _1684: x0 => x0.status,
      _1685: x0 => x0.statusText,
      _1687: (x0,x1) => { x0.responseType = x1 },
      _1688: x0 => x0.response,
      _1700: x0 => x0.loaded,
      _1701: x0 => x0.total,
      ...
      _3807: x0 => x0.protocol,
      _3811: x0 => x0.hostname,
      _3859: x0 => x0.error,
      ...
      _3972: x0 => x0.data,
      _4129: x0 => x0.length,
      _4346: x0 => x0.readyState,
      _4359: (x0,x1) => { x0.binaryType = x1 },
      _4362: x0 => x0.code,
      _4363: x0 => x0.reason,
      _6054: x0 => x0.detail,
      _6071: x0 => x0.signal,
      ...
      _9004: x0 => x0.state,
      _10324: x0 => x0.coords,
      _10325: x0 => x0.timestamp,
      _10327: x0 => x0.accuracy,
      _10328: x0 => x0.latitude,
      _10329: x0 => x0.longitude,
      _10332: x0 => x0.heading,
      _10333: x0 => x0.speed,
      _12243: x0 => x0.name,
